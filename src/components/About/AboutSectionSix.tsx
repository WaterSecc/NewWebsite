...
const team = [
  {
    name: "Mariem Loukil",
    title: "Data & AI Consultant and Instructor  PhD Candidate",
    image: "/images/about/Mariem.jpeg",
    linkedin: "https://www.linkedin.com/in/mariem-loukil/",
  },
  {
    name: "Omar Ben Tanfous",
    title: "Computer Vision Research Engineer",
    image: "/images/about/Omar.png",
    linkedin: "https://www.linkedin.com/in/omarbentanfous/",
  },
  {
    name: "Aziza Taboubi",
...
const NextArrow = ({ onClick }: any) => (
  <button type="button" aria-label="Next" onClick={onClick} className="members-chev members-chev--right">
    <Chevron dir="right" />
  </button>
);
  ...
  return (
    <section className="relative z-10 bg-white py-12 md:py-16 lg:py-20">
      <div className="container">
        ...
        <div className="members-slider relative overflow-visible">
          <Slider {...settings}>
            {team.map((member, index) => (
              <div key={index} className="px-3 text-center">
                ...
                <h3 className="text-lg font-semibold text-watersecblue">{member.name}</h3>
      ...
      <style jsx global>{`
        ...
        .members-slider .members-chev:hover { color: rgba(148, 163, 184, 0.9); }
        .members-slider .members-chev--left  { left: -18px; }
        .members-slider .members-chev--right { right: -18px; }
      `}</style>
    </section>
  );
};
