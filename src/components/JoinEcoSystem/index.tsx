                ...
                <div className="-mx-4 flex flex-wrap items-center">
                    ...
                    <div className="w-full px-4 lg:w-5/12 xl:w-4/12 mb-10 lg:mb-0">
                        <div className="relative aspect-[4/5] w-full overflow-hidden">
                            ...
                            <Image
                                src="/images/about/about2.png" // Replace with your image path
                                alt="Request a demo"
                                width={900}
                                height={900}
                    ...
                    <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
                        <div className="rounded-xs bg-white px-8 py-11 shadow-three dark:bg-gray-dark sm:p-[55px] lg:px-8 xl:p-[55px]">
                            ...
                            <p className="mb-12 text-base font-medium text-body-color">
                                Are you pitching some eco-friendly products? Do you want to partner with us to help us achieve our mission?
                            </p>
                            <form>
                                    ...
                                    <div className="w-full px-4 md:w-1/2">
                                        <div className="mb-8">
                                            ...
                                            <select
                                                id="company-size"
                                                name="company-size"
                                                className="appearance-none border-stroke w-full rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-hidden focus:border-watersecblue dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-watersecblue dark:focus:shadow-none"
                                            >
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="relative border-dashed border-2 border-gray-300 rounded-xs bg-[#f8f8f8] dark:bg-[#2C303B] p-6 text-center cursor-pointer hover:border-watersecblue transition">
                                                ...
                                                <p className="text-body-color text-sm">
                                                    Have any files to describe the project? Drag and drop them here, or click to upload <br />
