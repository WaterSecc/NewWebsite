      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-150 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="ring-watersecblue absolute top-1/2 right-4 block translate-y-[-50%] rounded-lg px-3 py-[6px] focus:ring-2 lg:hidden"
                >
                  <span
                        ...
                        {menuItem.path ? (
                          <Link
                            ...
                            className={`flex py-2 text-base font-semibold lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
                                ? "text-waterseclight dark:text-white"
                                : "text-darkergray hover:text-watersecblue dark:text-white/70 dark:hover:text-white"
                              }`}
                          ...
                          <>
                            <p
                              ...
                              className="text-dark group-hover:text-watersecblue flex cursor-pointer items-center justify-between py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 dark:text-white/70 dark:group-hover:text-white"
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="text-dark hover:text-watersecblue block rounded-sm py-2.5 text-sm lg:px-3 dark:text-white/70 dark:hover:text-white"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
              ...
              <div className="flex items-center justify-end space-x-4 pr-16 lg:pr-0">
                ...
                <Link
                  href="/demo"
                  className="ease-in-up shadow-btn hover:shadow-btn-hover bg-watersecblue hover:bg-watersecblue/90 hidden rounded-xs px-8 py-3 text-base font-medium text-white transition duration-300 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Request a DEMO
                </Link>
                <div>
